...
class GTPObject:
    ...
    def hidden_image(self) -> disnake.File:
        return disnake.File(f"images/hidden_pokemons/{self.pokemon_id}.png")

    @property
    def revealed_image(self) -> disnake.File:
        return disnake.File(f"images/revealed_pokemons/{self.pokemon_id}.png")
